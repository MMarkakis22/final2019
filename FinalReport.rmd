...
A new  preventative aides (abacavirinol) is under test in clinical trials. Analyze the effectiveness of this drug across the board. Consider population subgroups by gender, drug use, and sexual orientation. The data came from a clinical trial. The trial is trying to find out if the medication makes a difference in treating aids. Does gender make a difference? The trials also tried to answer whether drug users have a different affectand/or sexual preference makes a difference?
