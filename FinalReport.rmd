...
Based on the data in the above bar chart, it appears that the drug was more affective than the placebo. It appears that people that dont have AIDS have a very similar result between the drug and the placebo. It appears that we would reject the null hypothesis for this bar graph test.
...
We conclude that we have the evidence to support the contention that the vaccine for people with AIDS is affective.
...
$H_A$: The vaccine affects whether or not a women contracts AIDS.  
In this case the p-value for the Chisq test is 0 < 0.05 so we reject the null hypothesis.  
We conclude that we have the evidence to support the contention that the vaccine for women with AIDS is affective.
...
We conclude that we have the evidence to support the contention that the vaccine for drug users with AIDS is affective.
...
$H_A$: The vaccine affects whether or not LGBTQ people contracts AIDS.  
The p-value for the Chisq test is 0 < 0.05 so we reject the null hypothesis.  
We conclude that we have the evidence to support the contention that the vaccine for LGBTQ people with aids is affective.
